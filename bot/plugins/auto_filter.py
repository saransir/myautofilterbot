        ...
        for filter in filters: # iterating through each files
         ...
         Send_message=await bot.send_photo(
                ...
                caption=f"❗️❗️𝘊𝘰𝘶𝘭𝘥𝘯'𝘵 𝘍𝘪𝘯𝘥 𝘛𝘩𝘪𝘴 𝘔𝘰𝘷𝘪𝘦❗️❗️\n\n ⚠️𝙋𝙡𝙚𝙖𝙨𝙚 𝙘𝙝𝙚𝙘𝙠 𝙩𝙝𝙚 𝙨𝙥𝙚𝙡𝙡𝙞𝙣𝙜⚠️ \n\n"
                        ...
                        f"<i>⭕️ സിനിമ ചോദിച്ചിട്ട് കിട്ടിയില്ല എങ്കിൽ അത് നിങ്ങൾ ചോദിച്ചതിന്റ കുഴപ്പമാണ്സിനിമയുടെ ശരിയായ സ്പെല്ലിംഗ് അടിച്ചാൽ മാത്രമേ നിങ്ങൾക്ക് മൂവി ലഭിക്കുകയുള്ളൂ",
                parse_mode="html",
